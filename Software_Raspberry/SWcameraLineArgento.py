    ...
    try:
        ...
        while True:
            ...
            if msg == 's':
                ...
                f_argento=1#per non farlo correggere prima che veda argento
                f_argento_sicuro=False
                f_cont_argento=0
                f_end_argento=1
                f_linea=True
            ...
            if (f_verde=='v' or (cv2.countNonZero(imggreen[0:5,0:320])>70)) and f_no_verde==0 and f_controllo_buffer==0:
                ...
                if corners is not None and f_inizio_correzione_gap==0:#aggiunto flag per essere sicuri di corregere
                    ...
                    print(contA,contC,'',f_argento_sicuro,f_linea,f_end_argento)
                    if (contA>7 or contC>4) and f_argento_sicuro==False and f_linea and f_end_argento!=2:
                        ...
                        #ind+=1
                    elif (contA>4 or contC>4) and f_argento_sicuro==False and f_linea and f_end_argento!=2:
                        print(f_cont_argento)
                        ...
                        f_curvasx=0
                        send_to_arduino(2)
                    if (f_argento_sicuro or f_cont_argento>=5) and f_linea and f_end_argento!=2:
                    ...
                    if(ultima_distanza_sx>-148  or ultima_distanza_dx<148) and f_inizio_correzione_gap==0 and f_fine_correzione_gap==0 and f_end_argento!=1:
